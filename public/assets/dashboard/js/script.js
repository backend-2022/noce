...
$(document).ready(function () {
  var table = $('.table.datatable').DataTable({
    ...
    language: {
      url: window.datatableArabicLangUrl || 'assets/dashboard/js/datatable/ar.json',
    },
  });
...
const sun = document.querySelector('.sun_img');
const moon = document.querySelector('.moon_img');
const body = document.body;

// عند تحميل الصفحة: لو في LocalStorage خلي الوضع محفوظ
if(localStorage.getItem('theme') === 'dark') {
  body.classList.add('dark_mode');
}

// لما اضغط القمر → افعل الدارك مود
moon.addEventListener('click', () => {
  body.classList.add('dark_mode');
  localStorage.setItem('theme', 'dark');
});

// لما اضغط الشمس → الغي الدارك مود

  ...
  <footer>
      <div class="footer-content">
          ...
          <div class="social-links">
              ...
              @if($facebook)
              <a href="{{ $facebook }}" class="social-link" title="فيسبوك" target="_blank" rel="noopener noreferrer">
              ...
              @if($instagram)
              <a href="{{ $instagram }}" class="social-link" title="انستغرام" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              @if($twitter)
              <a href="{{ $twitter }}" class="social-link" title="تويتر" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              @if($snapchat)
              <a href="{{ $snapchat }}" class="social-link" title="سناب شات" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              @if($whatsappUrl)
              <a href="{{ $whatsappUrl }}"
                  class="whatsapp-btn social-link" target="_blank" rel="noopener noreferrer">

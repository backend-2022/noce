...
@section('content')
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
            body {
                background-image: url('assets/dashboard/media/auth/bg7.jpg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('assets/dashboard/media/auth/bg7-dark.jpg');
            }
        </style>
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <div class="mb-11">
                            <img src="assets/dashboard/media/auth/500-error.png" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="assets/dashboard/media/auth/500-error-dark.png"

...
@section('pageTitle', 'إدارة التجار')
@section('searchPlaceholder', 'ابحث عن المتجر او التاجر')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="merchants-table" class="table table-bordered tabel_style w-100">
                        <thead>
                            <tr>
                                {{-- <th>
...
@push('js')
    ...
    <script>
        var currentRouteName = 'dashboard.merchants.index';
        $(document).ready(function() {
            initDataTable(
                '#merchants-table',
                '{{ route('dashboard.merchants.index') }}',
                [
                    // {
                    //     data: 'select',
                    //     name: 'select',

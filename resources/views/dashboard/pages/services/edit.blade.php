...
@section('pageTitle', 'تعديل الخدمة')

@section('content')
    <div class="inner-body user_information">
        <form id="updateServiceForm" action="{{ route('dashboard.services.update', $service) }}" method="POST" autocomplete="off">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                    <div class="div_input_label">
                        ...
                        <textarea id="description" name="description"
                            ...
                            autocomplete="off"
                            data-lpignore="true">{{ old('description', $service->description) }}</textarea>
                        @error('description')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <button type="submit" class="save_informations" id="submitBtn">
                ...
                <span class="button-text">تحديث الخدمة</span>
            </button>
        </form>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            if (typeof handleFormSubmission === 'function') {
                handleFormSubmission('#updateServiceForm', {

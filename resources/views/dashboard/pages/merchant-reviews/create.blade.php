...
<head>
    ...
    <title>إضافة تقييم تاجر جديد - جدولها</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h2 class="page-title">إضافة تقييم تاجر جديد</h2>
        ...
        <div class="form-container">
            @if ($errors->any())
                <div style="background: #f8d7da; color: #721c24; padding: 1rem; border-radius: 5px; margin-bottom: 1rem; border: 1px solid #f5c6cb;">
                    <h4 style="margin-bottom: 0.5rem;">يرجى تصحيح الأخطاء التالية:</h4>
            ...
            <form action="{{ route('dashboard.merchant-reviews.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="business_title" class="form-label">الوصف الوظيفي</label>
                ...
                <div class="form-group">
                    ...
                    <textarea id="review_text" name="review_text" class="form-textarea" required>{{ old('review_text') }}</textarea>
                    @error('review_text')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="rating-group">
                        ...
                        <span id="rating-text">اختر التقييم</span>
                    </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-submit">إضافة التقييم</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        ratingText.textContent = `${initialRating}/5`;
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!merchantName) {
                ...
                document.getElementById('merchant_name').focus();
                return false;
            }

            if (!reviewText) {
                e.preventDefault();
                alert('نص التقييم مطلوب');
            ...
            if (!rating || rating < 1 || rating > 5) {
                e.preventDefault();
                alert('يرجى اختيار تقييم صحيح (1-5)');
                return false;
            }

...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_FOLDER', 'backup'),

        /*
         * The storage directory where backups will be stored after processing.
         */
        'storage_directory' => env('BACKUP_STORAGE_DIRECTORY', 'backups'),
